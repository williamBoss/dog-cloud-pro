...
public class RSAUtil {
    ...
    public static String encrypt(String text, String publicKey) {
        ...
        try {
            ...
            final String result = Base64.getEncoder().encodeToString(cipher.doFinal(text.getBytes(Constants.UTF8)));
            return result;
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
    ...
    public static String decrypt(String ciphertext, String privateKey) {
        ...
        try {
            //64位解码加密后的字符串
            final byte[] bytes = Base64.getDecoder().decode(ciphertext.getBytes(Constants.UTF8));
            //base64编码的私钥
