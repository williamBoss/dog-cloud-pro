package com.dog.cloud.cache.aspect;

import com.dog.cloud.cache.annotation.RedisCache;
import com.dog.cloud.cache.annotation.RedisEvict;
...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.dog.cloud.cache.annotation.RedisCache)")
    public void redisCachePoint() {
    }

    @Pointcut("@annotation(com.dog.cloud.cache.annotation.RedisEvict)")
    ...
    public Object writeReadFromRedis(ProceedingJoinPoint point) {
        try {
            ...
            logger.error("<====== RedisCache 执行异常: {%s} ======>", ex);
        }
        return null;
    }
