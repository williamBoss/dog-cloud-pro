...
import com.dog.cloud.system.domain.vo.MetaVo;
import com.dog.cloud.system.domain.vo.RouterVo;
import com.dog.cloud.system.domain.vo.TreeSelect;
import com.dog.cloud.system.mapper.SysMenuMapper;
import com.dog.cloud.system.mapper.SysRoleMapper;
import com.dog.cloud.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public boolean isMeunFrame(SysMenu menu) {
        return menu.getParentId().intValue() == 0 && UserConstants.TYPE_MENU.equals(menu.getMenuType()) && menu
            .getIsFrame().equals(UserConstants.NO_FRAME);
    }
